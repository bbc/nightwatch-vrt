...
const {merge: lodashMerge, filter: lodashFilter, pick: lodashPick, isEmpty}= require('lodash');
...
class Reporter {
  ...
  publishReport(data) {
    ...
    writeNightwatchHTMLReport(path.join(process.cwd(), 'vrt-report'), JSON.stringify(result));
  }
